...
//                'type' => $request->input('payment_method'),
            ...
            try {
                ...
                if ($useWallet) {
                    ...
                    if (!$freezeResult['success']) {
                        Log::warning('Wallet freeze failed', [
                ...
                if ($gatewayAmount > 0) {
                    ...
                    if ($walletApplied > 0 && $walletTransaction) {
                        ...
                        $paymentIntent->update([
                            ...
                            'charge_id' => $gatewayResult['checkoutUrl']['order_ref'] ?? ($gatewayAmount > 0 ? null : 'wallet_only'),
                ...
                Log::info('Split payment completed successfully with lot management', $result);
    ...
    public function deductReleaseWalletFreeze($user, $walletApplied, $actualOrderId, $walletTransaction, $gatewayAmount = 0.00):void
    {
        ...
        Log::info('Frozen wallet amount deducted with lot consumption:', [
            'amount' => $walletApplied,
...
//                DB::rollBack();
                return [
                    'success' => true, // Still success, just no wallet balance
                    'amount_frozen' => 0,
