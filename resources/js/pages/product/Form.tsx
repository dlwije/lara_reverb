...
export default function ProductForm({
    ...
    return (
        <AdminLayout>
            <div className="pt-6 pb-0 sm:py-8 px-0 sm:px-6 lg:px-8">
                <FormSection onSubmit={handleSubmit}>
                    {/* Header */}
                    <div className="mb-8">
                        <div className="w-full block sm:flex sm:items-start sm:justify-between lg:block">
                            <div>
                            ...
                            <div className="mt-6 sm:mt-0 lg:mt-6 me-3">
                                <Link
                    ...
                    <div className="grid grid-cols-6 gap-6">
                        ...
                        {data.type === "Combo" && (
                            <div className="col-span-full p-6 mb-6 rounded-sm border border-gray-200 dark:border-gray-700">
                                <div className="relative">
                                    ...
                                    {search && result && result.length > 0 && (
                                        <div className="absolute z-10 top-full left-0 right-0 ring-1 bg-white dark:bg-gray-700 rounded-md dark:ring-gray-700 mt-2 py-1">
                                            {result.map((p) => (
                                                <button
                                                    key={p.id}
                                                    type="button"
                                                    onClick={() => addProduct(p)}
                                                    className="w-full text-left py-1.5 px-4 hover:bg-gray-100 dark:hover:bg-gray-900"
                                                >
                                                    {p.name}
                                                </button>
                                            ))}
                                ...
                                {data.products && data.products.length > 0 && (
                                    <div>
                                        <h4 className="text-lg font-bold mt-6 mb-3">{t("Combo Products")}</h4>
                                                ...
                                                <tr key={product.code}>
                                                    ...
                                                    <td className="w-36 py-2">
                                                        <Input
                                                            ...
                                                            onChange={(e) => {
                                                                const updatedProduct = { ...product, quantity: Number.parseInt(e.target.value) || 0 }
                        ...
                        {!["Combo", "Recipe"].includes(data.type) && data.unit_prices && unit?.subunits?.length > 0 && (
                            <>
                                {unit.subunits.map((subunit: any) => (
                                    <div
                                        key={subunit.id}
                                        className="col-span-full relative grid grid-cols-6 gap-6 rounded-md mt-3 pt-8 pb-4 px-4 border border-gray-200 dark:border-gray-700"
                                    >
                                        <div className="absolute -top-4 left-4 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md py-0.5 px-3 font-extrabold text-lg flex items-center gap-x-4">
                                            {subunit.name}
                                        </div>
                                        <div className="col-span-6 sm:col-span-3">
                                            <Input
                        ...
                        <div className="col-span-full">
                            ...
                            {!photoPreview && current?.photo && (
                                <div className="mt-2 p-1 rounded-md">
                                    <img
                                        ...
                                        className="rounded-md w-full h-full max-w-64 min-h-20 max-h-40 object-contain"
                                    />
                                </div>
                            )}
                            ...
                            {photoPreview && (
                                <div className="mt-2 p-1 rounded-md">
                                    <div
                                        className="block rounded-md w-full h-full max-w-64 min-h-24 max-h-40 bg-no-repeat bg-contain"
                            ...
                            {current?.photo && (
                                <SecondaryButton
                                    type="button"
                                    onClick={deletePhoto}
                                    className="mt-2 p-1 rounded-md bg-gray-50 flex items-center justify-center"
                                >
                                    {t("Remove Photo")}
                                </SecondaryButton>
                            )}
                        ...
                        {/* Toggle Options */}
                        <div className="col-span-full flex flex-col gap-2 rounded-md p-4 border border-gray-200 dark:border-gray-700 overflow-x-auto">
                            <Toggle
                                id="featured"
                                label={t("Featured")}
                                        ...
                                        <div className="grid grid-cols-6 gap-6">
                                            <div className="col-span-full mt-6 flex items-center justify-between">
                                                ...
                                                <button
                                                    ...
                                                    className="relative -ml-px inline-flex items-center rounded-md bg-white dark:bg-gray-900 px-2 py-2 text-gray-500 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-950 focus:z-10"
                                                >
                                            ...
                                            {data.variants.map((variant, index) => (
                                                <div
                                                    key={`variant_${index}`}
                                                    className="relative col-span-full grid grid-cols-6 gap-6 rounded-md mt-2 px-6 pt-10 pb-6 border border-gray-200 dark:border-gray-700"
                                                >
                                                    <div className="absolute -top-4 left-4 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md py-0.5 px-3 font-extrabold text-lg flex items-center gap-x-4">
                                                        ...
                                                        <button
                                                            ...
                                                            className="relative inline-flex items-center rounded-md -mr-2.5 p-1 text-gray-500 hover:text-red-700 hover:bg-red-100 dark:hover:text-red-200 dark:hover:bg-red-950 focus:z-10"
                                                        >
                                                    ...
                                                    <div className="col-span-full flex items-end gap-6">
                                                        ...
                                                        <button
                                                            ...
                                                            className="relative inline-flex items-center rounded-md bg-white dark:bg-gray-900 p-2.5 text-gray-500 ring-1 ring-inset ring-gray-300 dark:ring-gray-700 hover:bg-gray-50 dark:hover:bg-gray-950 focus:z-10"
                                                        >
                                                            <Icon name="add" size="w-5 h-5 sm:mr-2" />
                                            ...
                                            {data.variations.length > 0 && (
                                                <>
                                                    ...
                                                    <div className="col-span-full overflow-x-auto border-l border-gray-200 dark:border-gray-700">
                                                        <div className="inline-block min-w-full align-middle dark:border-gray-700 -ml-px">
                                                            <table className="w-full border-separate border-spacing-0">
                                                                ...
                                                                <tr className="bg-gray-50 dark:bg-gray-800">
                                                                    {data.variants.map((va, vi) => (
                                                                        <th
                                                                            key={`option${vi}`}
                                                                            className="border-l border-y border-gray-200 dark:border-gray-700 px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider"
                                                                        >
                                                                            {va.name}
                                                                        </th>
                                                                    ))}
                                                                    <th className="border-l border-y border-gray-200 dark:border-gray-700 px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                                        {t("Code")}
                                                                    </th>
                                                                    <th className="border-l border-y border-gray-200 dark:border-gray-700 px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">
                                                                        {t("Cost")}
                                                                    ...
                                                                    <th className="border border-gray-200 dark:border-gray-700 px-3 py-2"></th>
                                                                </tr>
                                                                </thead>
                                                                <tbody>
                                                                {data.variations.map((variation, index) => (
                                                                    ...
                                                                    >
                                                                        {data.variants.map((va, vi) => (
                                                                            <td
                                                                                key={`option${vi}`}
                                                                                className="border-b border-l border-gray-200 dark:border-gray-700 px-3 py-2"
                                                                            >
                                                                                {variation.meta?.[va.name]}
                                                                            </td>
                                                                        ))}
                                                                        <td className="border-b border-l border-gray-200 dark:border-gray-700 px-3 py-2">
                                                                            <input
                                                                                ...
                                                                                className="w-24 py-0 px-2 border-0 bg-transparent focus:ring-0"
                                                                            />
                                                                        </td>
                                                                        <td className="border-b border-l border-gray-200 dark:border-gray-700 px-3 py-2">
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    const updatedVariations = [...data.variations]
                                                                                    updatedVariations[index].cost = Number.parseFloat(e.target.value) || 0
                                                                                    setData({ ...data, variations: updatedVariations })
                                                                                }}
                                                                                className="w-24 py-0 pl-2 pr-0 border-0 bg-transparent focus:ring-0"
                                                                            />
                                                                        </td>
                                                                        <td className="border-b border-l border-gray-200 dark:border-gray-700 px-3 py-2">
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    const updatedVariations = [...data.variations]
                                                                                    updatedVariations[index].price = Number.parseFloat(e.target.value) || 0
                                                                                    setData({ ...data, variations: updatedVariations })
                                                                                }}
                                                                                className="w-24 py-0 pl-2 pr-0 border-0 bg-transparent focus:ring-0"
                                                                            />
                                                                        ...
                                                                        <td className="border-b border-l border-gray-200 dark:border-gray-700 px-3 py-2">
                                                                            <input
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    const updatedVariations = [...data.variations]
                                                                                    updatedVariations[index].weight = Number.parseFloat(e.target.value) || 0
                                                                                    setData({ ...data, variations: updatedVariations })
                                                                                }}
                                                                                className="w-24 py-0 pl-2 pr-0 border-0 bg-transparent focus:ring-0"
                                                                            />
                                                                        ...
                                                                        <td className="border-b border-l border-r border-gray-200 dark:border-gray-700 text-center px-3 py-2">
                                                                            <button
                                                                                type="button"
                                                                                onClick={() => {
                                                                                    const updatedVariations = data.variations.filter((_, i) => i !== index)
                                                                                    setData({ ...data, variations: updatedVariations })
                                                                                }}
                                                                                className="relative inline-flex items-center rounded-md -ml-3 p-1 text-gray-500 hover:text-red-700 hover:bg-red-100 dark:hover:text-red-200 dark:hover:bg-red-950 focus:z-10"
                                                                            >
                                                                                <span className="sr-only">{t("Remove")}</span>
                                                                                <Icon name="trash-o" size="w-5 h-5" />
                                                                            </button>
                            ...
                            <div className="col-span-full flex flex-col gap-2 rounded-md p-4 border border-gray-200 dark:border-gray-700 overflow-x-auto">
                                ...
                                {!data.dont_track_stock && !data.has_variants && (
                                    <>
                                        ...
                                        {data.set_stock && (
                                            <div className="col-span-full flex flex-col gap-8 mt-8">
                                                {stores.map((store, index) => (
                                                    <div
                                                        key={store.id}
                                                        className="relative grid grid-cols-6 gap-6 px-6 pt-10 pb-6 border border-gray-200 dark:border-gray-700 rounded-md"
                                                    >
                                                        <div className="absolute -top-4 left-4 bg-gray-100 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-md py-0.5 px-3 font-extrabold text-lg">
                                                            {store.name}
                                                        </div>
                        ...
                        {/* SEO Fields */}
                        <div className="col-span-full flex flex-col gap-6 p-6 mb-6 rounded-sm border border-gray-200 dark:border-gray-700">
                            <div className="col-span-full -mt-6 -mb-3">
                                <h4 className="text-lg font-bold mt-6 mb-3">{t("SEO Fields")}</h4>
                            </div>
                            <div>
                                <Input
                                    id="title"
                    ...
                    <div className="flex items-center justify-end pt-6">
                        ...
                        <ActionMessage on={recentlySuccessful} className="ms-3 me-3">
                            {t("Saved.")}
                        </ActionMessage>
