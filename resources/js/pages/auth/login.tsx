...
export default function Login({ status, canResetPassword }: LoginProps) {
    ...
    return (
        <AuthLayout title="Taggo.ae" description="Enter your email and password below to log in">
            <Head title="Log in" />

            <form className="p-8" onSubmit={submit}>
                <div className="flex flex-col gap-6">
                    <AuthHeader title="Taggo.ae" description="Login to your Taggo Inc account" />
