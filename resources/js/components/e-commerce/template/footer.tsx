            ...
            <div className="max-w-7xl mx-auto">
                <Card className="border-0 shadow-none">
                    <CardContent className="p-0">
                        <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-2">
                            <div className="flex-1">
                                <Link
                                    href="/"
                                    className="text-4xl font-semibold text-foreground hover:opacity-80 transition-opacity"
                                >
                                    <span className="text-primary">DS</span><span className={`text-green-500 dark:text-green-400`}>stack</span>
                                    <span className="text-primary text-5xl leading-0">.</span>
                                </Link>
                                <p className="max-w-[410px] mt-6 text-sm text-muted-foreground">
                                    Welcome to DSstack, your ultimate destination for the latest and smartest gadgets.
                            ...
                            <div className="flex flex-wrap justify-between w-full md:w-[45%] gap-8 text-sm">
                                {linkSections.map((section, index) => (
                                    <div key={index} className="min-w-[140px]">
                                        <h3 className="font-medium text-foreground md:mb-5 mb-3">
                                            {section.title}
                                        </h3>
                ...
                <p className="py-2 text-sm text-muted-foreground text-center md:text-left">
                    Copyright 2025 © dsstack All Right Reserved.
                </p>
            </div>
        </footer>
    );
